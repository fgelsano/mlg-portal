...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow no-print">
    ...
    <ul class="navbar-nav ml-auto" id="page-top">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <!-- Counter - Alerts -->
            <span class="badge badge-danger badge-counter d-none" id="alerts-badge">0</span>
            </a>
            <!-- Dropdown - Alerts -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <div id="alerts-list" data-role="{{ Auth::user()->role }}" data-counter=""></div>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="dropdown-item" href="{{ route('profile.show',Auth::user()->profile_id) }}">
