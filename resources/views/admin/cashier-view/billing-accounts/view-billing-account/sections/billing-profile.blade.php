{{-- <div class="row mt-3 mb-3 text-white text-uppercase py-2">
    <div class="col-md-2 col-12">
        <button class="btn btn-outline-danger btn-block btn-sm" id="btnAddBill"><i class="fas fa-file-invoice mr-2"></i>New Bill</button>
    </div>
    <div class="col-md-6 col-12 bg-danger py-1 text-center text-uppercase">Billing Account</div>
    <div class="col-md-2 col-12">
        <button class="btn btn-success btn-block btn-sm" id="btnSendEmail"><i class="fas fa-paper-plane mr-2"></i>Send Email</button>
    </div>
    <div class="col-md-2 col-12">
        <button class="btn btn-primary btn-block btn-sm" id="btnSendSMS"><i class="fas fa-sms mr-2"></i>Send SMS</button>
    </div>
</div> --}}
...
<div class="row mt-3 mb-3 text-white text-uppercase py-2">
    ...
    <div class="col-md-10 col-12 bg-danger py-1 text-center text-uppercase">Billing Account</div>
</div>
                    ...
                    <div class="card-body">
                        <div class="row d-flex flex-row-reverse flex-md-row border-bottom mb-3">
                            ...
                            <div class="col-md-4 col-12 text-md-right text-center">
                                <button type="button" class="btn btn-outline-danger btn-sm" data-id="{{ $assessment->id }}">
